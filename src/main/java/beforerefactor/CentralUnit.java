...
{
	// afterrefactor.sensor test status options
	...
	// members to help with afterrefactor.sensor tests
	...
	public void parseRadioBroadcast(String packet)
	{
		...
		// find afterrefactor.sensor with id
		Sensor sensor = null;
		...
		//trip or reset afterrefactor.sensor
		if(sensor != null)
		{
		...
		//get the message from the afterrefactor.sensor and display it
		...
		// check if a afterrefactor.sensor test is running and adjust status
	...
	// used during afterrefactor.sensor test
	public void terminateSensorTest()
	{
		runningSensorTest = false;

		// look at individual afterrefactor.sensor status to determine the overall test status
